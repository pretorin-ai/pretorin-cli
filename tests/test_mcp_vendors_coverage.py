...
class TestHandleCreateVendor:
    ...
    async def test_success(self):
        ...
        result = await handle_create_vendor(
            client,
            {
                "name": "Acme",
                "provider_type": "IaaS",
...
class TestHandleUpdateVendor:
    ...
    async def test_success(self):
        ...
        result = await handle_update_vendor(
            client,
            {
                "vendor_id": "v1",
                "name": "Updated",
...
class TestHandleUploadVendorDocument:
    ...
    async def test_success(self):
        ...
        result = await handle_upload_vendor_document(
            client,
            {
                "vendor_id": "v1",
...
class TestHandleLinkEvidenceToVendor:
    ...
    async def test_success(self):
        ...
        result = await handle_link_evidence_to_vendor(
            client,
            {
                "evidence_id": "e1",
                "vendor_id": "v1",
...
class TestHandleGetControlResponsibility:
    ...
    async def test_success(self):
        ...
        result = await handle_get_control_responsibility(
            client,
            {
                "system_id": "sys-1",
                "control_id": "AC-2",
...
class TestHandleSetControlResponsibility:
    ...
    async def test_success(self):
        ...
        result = await handle_set_control_responsibility(
            client,
            {
                "system_id": "sys-1",
                "control_id": "AC-2",
                "framework_id": "fw-1",
                "responsibility_mode": "shared",
            },
        )
...
class TestHandleRemoveControlResponsibility:
    ...
    async def test_success(self):
        client = _make_client()
        result = await handle_remove_control_responsibility(
            client,
            {
                "system_id": "sys-1",
                "control_id": "AC-2",
...
class TestHandleGenerateInheritanceNarrative:
    ...
    async def test_success(self):
        ...
        result = await handle_generate_inheritance_narrative(
            client,
            {
                "system_id": "sys-1",
                "control_id": "AC-2",
