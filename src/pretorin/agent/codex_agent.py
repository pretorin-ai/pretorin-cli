...
class CodexAgent:
    ...
    def _build_prompt(self, task: str, skill: str | None) -> str:
        ...
        base = (
            ...
            "   suggested_evidence_type: <attestation|certificate|code_snippet|"
            "configuration|interview_notes|log_file|other|policy_document|"
            "repository_link|scan_result|screen_recording|screenshot|test_result>\n"
            "   [[/PRETORIN_TODO]]\n"
